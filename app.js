...
$__System.registerDynamic("d", ["5", "b"], true, function($__require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
  var $export = $__require('5'),
      $values = $__require('b')(false);
...
$__System.registerDynamic("e", ["d", "6"], true, function($__require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
  $__require('d');
  module.exports = $__require('6').Object.values;
  global.define = __define;
  return module.exports;
});
...
$__System.register('11', ['10', '12', '13', '14', '15', 'f'], function (_export) {
  var $, readonly, _createClass, _classCallCheck, _Object$values, TPL_ELEMENT, ORIENTATION, ORIENTATION_SIZE_ATTR_NAMES, ORIENTATION_POSITION_ATTR_NAMES, Line;

  return {
    setters: [function (_3) {}, function (_4) {
      $ = _4['default'];
    }, function (_5) {
      readonly = _5.readonly;
    }, function (_) {
      _createClass = _['default'];
    }, function (_2) {
      _classCallCheck = _2['default'];
    }, function (_f) {
      _Object$values = _f['default'];
    }],
    execute: function () {
      'use strict';

      TPL_ELEMENT = '<span class="burndown__line"></span>';
      ORIENTATION = {
        HORIZONTAL: 0,
        VERTICAL: 1
      };
      ...
      ORIENTATION_SIZE_ATTR_NAMES = ['width', 'height'];

      _export('ORIENTATION_SIZE_ATTR_NAMES', ORIENTATION_SIZE_ATTR_NAMES);

      ORIENTATION_POSITION_ATTR_NAMES = ['top', 'left'];

      _export('ORIENTATION_POSITION_ATTR_NAMES', ORIENTATION_POSITION_ATTR_NAMES);

      Line = (function () {
        function Line(id, orientation) {
          _classCallCheck(this, Line);

          if (!(orientation in _Object$values(ORIENTATION))) {
        ...
        _createClass(Line, [{
          ...
          value: function _createElement() {
            ...
            var attr1 = ORIENTATION_SIZE_ATTR_NAMES[o];
            var attr2 = ORIENTATION_SIZE_ATTR_NAMES[+!o];

            return $(TPL_ELEMENT).attr('id', 'burndown__line__' + this.id).css(attr1, this.__size).css(attr2, '0px');
          }
        }, {
          key: '_updateElementPosition',
          value: function _updateElementPosition() {
            var o = this.orientation;
            var attr1 = ORIENTATION_POSITION_ATTR_NAMES[o];
            var attr2 = ORIENTATION_POSITION_ATTR_NAMES[+!o];

            this.__element.css(attr1, (this.__value + this.__offset[o] || 0) + 'px').css(attr2, (this.__offset[+!o] || 0) + 'px');
          }
        }, {
          key: '_updateElementSize',
          value: function _updateElementSize() {
            var o = this.orientation;
            var attr = ORIENTATION_SIZE_ATTR_NAMES[o];

            this.__element.css(attr, this.__size);
          }
        }, {
          key: 'element',
          get: function get() {
...
$__System.register('16', ['11'], function (_export) {
  'use strict';
...
(function() {
var _removeDefine = $__System.get("@@amd-helpers").createDefine();
define("12", ["18"], function(main) {
  return main;
});

_removeDefine();
})();
$__System.register('19', ['12', '13', '14', '15', '17'], function (_export) {
  var $, readonly, _createClass, _classCallCheck, TPL_ELEMENT, pixelsPerTime, ValueHour;
  ...
  return {
    ...
    execute: function () {
      ...
      TPL_ELEMENT = '<span class="burndown__value_hour"></span>';
      pixelsPerTime = 1;

      ValueHour = (function () {
        _createClass(ValueHour, null, [{
          key: 'pixelsPerTime',
          get: function get() {
        ...
        function ValueHour(id) {
          _classCallCheck(this, ValueHour);
        ...
        _createClass(ValueHour, [{
          key: '_createElement',
          value: function _createElement() {
            return $(TPL_ELEMENT).attr('id', 'burndown__value_hour__' + this.id);
          }
        }, {
          key: 'element',
          get: function get() {
          ...
          set: function set(value) {
            this.__value = value;
            this.__element.css('top', 'calc(100% - ' + (this.__value * this.pixelsPerTime || 0) + 'px)').text(this.__value.toFixed(2) + 'h');
          }
        }, {
          key: 'pixelsPerTime',
          get: function get() {
...
$__System.register('1b', ['12', '13', '14', '15', '16', '1c', '1a'], function (_export) {
  var $, readonly, _createClass, _classCallCheck, Line, ORIENTATION, ORIENTATION_SIZE_ATTR_NAMES, debounce, ValueHour, LINE_SIZE_CROP, LINE_POSITION_OFFSET, Burndown;

  return {
    setters: [function (_3) {
      $ = _3['default'];
    }, function (_4) {
      readonly = _4.readonly;
    }, function (_) {
      _createClass = _['default'];
    }, function (_2) {
      _classCallCheck = _2['default'];
      ...
      Line = _5.Line;
      ORIENTATION = _5.ORIENTATION;
      ORIENTATION_SIZE_ATTR_NAMES = _5.ORIENTATION_SIZE_ATTR_NAMES;
    }, function (_c) {
      debounce = _c.debounce;
    }, function (_a) {
      ValueHour = _a.ValueHour;
    }],
    execute: function () {
      'use strict';
      ...
      Burndown = (function () {
        ...
        _createClass(Burndown, [{
          ...
          key: '_updateReference',
          value: function _updateReference() {
          ...
          value: function _handleMouseMove(event) {
            ...
            var height = this.canvas.height() - LINE_SIZE_CROP.height;
          ...
          value: function _updateLinePosition(line) {
            line.value = line.orientation === ORIENTATION.VERTICAL ? this.__mousePosition.x : this.__mousePosition.y;
          }
        }, {
          key: '_updateLineSize',
          value: function _updateLineSize(line) {
            var sizeAttrName = ORIENTATION_SIZE_ATTR_NAMES[line.orientation];
            var sizeCrop = LINE_SIZE_CROP[sizeAttrName];
            var canvasSize = this.canvas[ORIENTATION_SIZE_ATTR_NAMES[line.orientation]]();

            line.size = canvasSize - sizeCrop;
          }
        }, {
          key: '_updateValueHour',
          value: function _updateValueHour(vh, value) {
            var height = this.canvas.height() - LINE_SIZE_CROP.height;

            if (value !== Number(value)) {
              var percentage = (height - this.__mousePosition.y) / height;
              var maxTick = this.getMaxTick();
      ...
      _export('Burndown', Burndown);
    }
  };
});
$__System.register('1d', ['1b'], function (_export) {
  'use strict';
...
$__System.registerDynamic("14", ["1e"], true, function($__require, exports, module) {
  "use strict";
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
  var _Object$defineProperty = $__require('1e')["default"];
...
$__System.registerDynamic("25", ["20", "22", "24"], true, function($__require, exports, module) {
  "use strict";
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
  var base64 = $__require('20');
  var ieee754 = $__require('22');
  var isArray = $__require('24');
...
$__System.registerDynamic("27", ["26"], true, function($__require, exports, module) {
  ...
  var global = this,
      __define = global.define;
  global.define = undefined;
  module.exports = $__System._nodeRequire ? $__System._nodeRequire('buffer') : $__require('26');
  global.define = __define;
  return module.exports;
});
...
$__System.registerDynamic("2d", ["28", "2c"], true, function($__require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
  ...
  })($__require('28').Buffer, $__require('2c'));
  global.define = __define;
  return module.exports;
});
...
$__System.registerDynamic("1e", ["2e"], true, function($__require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
...
$__System.register("13", ["1e"], function (_export) {
  var _Object$defineProperty;

  function readonly(obj, name, value) {
    _Object$defineProperty(obj, name, {
      value: value,
      writable: false,
      enumerable: true,
      configurable: false
  ...
  return {
    setters: [function (_e) {
      _Object$defineProperty = _e["default"];
    }],
    execute: function () {
      "use strict";
...
$__System.register('2f', ['13', '14', '15', '1c'], function (_export) {
  var readonly, _createClass, _classCallCheck, noop, TPL_TRAMPOLINE, TPL_TRAMPOLINE_REMOVE, Detourer;

  return {
    setters: [function (_3) {
      readonly = _3.readonly;
    }, function (_) {
      _createClass = _['default'];
    }, function (_2) {
      _classCallCheck = _2['default'];
    ...
    execute: function () {
      ...
      Detourer = (function () {
        ...
        _createClass(Detourer, [{
          ...
          key: '_createDetourScript',
          value: function _createDetourScript() {
            var source = this._createDetourFunction(this.__options);
            var script = this._createScript(source);

            return script;
          }
        }, {
          key: '_createRemovalScript',
          value: function _createRemovalScript() {
            var source = this._createRemovalFunction(this.__options);
            var script = this._createScript(source, true);

            return script;
          }
        }, {
          key: '_createScript',
          value: function _createScript(funcString) {
            var removeElement = arguments.length <= 1 || arguments[1] === undefined ? false : arguments[1];
          ...
          key: '_createDetourFunction',
          value: function _createDetourFunction(opts) {
            return TPL_TRAMPOLINE.replace(/\%FUNCTION_PATH\%/g, opts.functionPath).replace(/\%SERIALIZE_PATH\%/g, opts.serializePath).replace(/\%FUNCTION_ARGS\%/g, opts.functionArgs.join(',')).replace(/\%EVENT_NAME\%/g, this.eventName);
          }
        }, {
          key: '_createRemovalScript',
          value: function _createRemovalScript(opts) {
            return TPL_TRAMPOLINE_REMOVE.replace(/\%FUNCTION_PATH\%/g, opts.functionPath);
          }
        }, {
          key: '_createListener',
          value: function _createListener() {
            ...
            this.__listenerCallback = function (event) {
              _this.__data = JSON.parse(event.detail);
              _this.__callback(_this.__data);
            };
      ...
      _export('Detourer', Detourer);
    }
  };
});
$__System.register('1', ['12', '1d', '2f'], function (_export) {
  'use strict';

  var $, Burndown, Detourer, burndown, gh_data_model;
  return {
    setters: [function (_) {
      $ = _['default'];
    }, function (_d) {
      Burndown = _d.Burndown;
    }, function (_f) {
      Detourer = _f.Detourer;
    }],
    execute: function () {
      burndown = undefined;
      gh_data_model = new Detourer({
        name: 'gh_data_model',
...
(window['System'] || $__System).register('app/components/line/line.less!github:rafaelfbs/systemjs-less-plugin@1.4.2.js', [], false, function() {});
(window['System'] || $__System).register('app/components/value_hour/value_hour.less!github:rafaelfbs/systemjs-less-plugin@1.4.2.js', [], false, function() {});
(function(c){var d=document,a='appendChild',i='styleSheet',s=d.createElement('style');s.type='text/css';d.getElementsByTagName('head')[0][a](s);s[i]?s[i].cssText=c:s[a](d.createTextNode(c));})
(".burndown__line {\n  border: 1px solid #00FF08;\n  position: absolute;\n}\n.burndown__value_hour {\n  z-index: 9999;\n  background-color: whitesmoke;\n  color: red;\n  width: 60px;\n  height: 20px;\n  position: absolute;\n  left: -70px;\n  padding: 4px;\n  border-radius: 5px;\n  text-align: center;\n  border: 1px solid silver;\n}\n");
})
(function(factory) {
  factory();
});
